...
namespace WowApi
{
    ...
    public class WowApiClient : ObservableObject
    {
        ...
        /// <param name="apiKey">The key to allow API access</param>
        /// <param name="useLocaleSuffix">Specify if the locale suffix must be added to the request url</param>
        public WowApiClient(IDataProvider dataProvider, CultureInfo locale, string apiKey, bool useLocaleSuffix = true)
        {
        ...
        {
            return GetUrl(typeof(T), args);
        }

        public string GetUrl(Type dataType, params object[] args)
        {
            // retrieve the WowApiDataType to craft the url
            var type = WowApiDataType.AllDataTypes.FirstOrDefault(o => o.Type == dataType);
            if (type == null)
                throw new NotImplementedException("GetUrl : Unsupported data type " + dataType.FullName);
            ...
            }
            {
                ...
                // complete the url
                url = string.Concat(url, token, "apikey=", _apiKey);
            }
            ...
            where T : class
        {
            ...
            string data = DataProvider.ProvideData(url);
        ...
        /// ie : http://eu.api.battle.net/wow/achievement/2144
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/battlePet/ability/640
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/battlePet/species/258
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/battlePet/stats/258?level=25&breedId=5&qualityId=4
        /// </summary>
        /// <param name="id">The individual pet species id</param>
        ...
        // http://eu.api.battle.net/wow/character/Medivh/Uther?fields=achievements,appearance,feed,guild,hunterPets,items,mounts,pets,petSlots,professions,progression,pvp,quests,reputation,stats,talents,titles
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/item/18803
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/item/set/1060
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/quest/13146
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/recipe/33994
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/spell/8056
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/data/character/races
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/data/character/classes
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/data/character/achievements
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/data/item/classes
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/data/talents
        /// </summary>
        ...
        /// http://eu.api.battle.net/wow/data/pet/types
        /// </summary>
